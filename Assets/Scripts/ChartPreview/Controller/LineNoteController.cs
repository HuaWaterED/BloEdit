...
public class LineNoteController : MonoBehaviour
{
    ...
    private void Find_Get_Update_PassHit_Return(List<Note> lineNotes, ref int lastIndex, List<NoteController> ariseNotes, List<NoteController> endTime_ariseTime, bool isOnlineNotes)
    {
    ...
    private void FindAndGetNotes(List<Note> notes, ref int lastIndex, List<NoteController> arisedNotes, List<NoteController> endTime_arisedNotes, bool isOnlineNote)
    {
    ...
    private void GetNote(List<Note> notes, List<NoteController> arisedNotes, List<NoteController> endTime_arisedNotes, bool isOnlineNote, Vector3 direction, int i)
    {
